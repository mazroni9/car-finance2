/**
 * @file /src/app/dashboard/admin_logs/cars/linked-cars/page.tsx
 * @description عرض تفاصيل ربط السيارات - نسخة الأدمن الشاملة
 */
...
export default function AdminLinkedCarsPage() {
  ...
  return (
    <div className="p-4 space-y-6">
      <h1 className="text-2xl font-bold mb-6">تقرير ربط السيارات - لوحة الأدمن</h1>
