...
export default function AvailableCars() {
  ...
  async function handlePurchase(carId: string) {
    try {
      ...
      if (car && (car.id.startsWith('luxury-') || car.id.startsWith('classic-') || car.id.startsWith('sport-') || car.id.startsWith('family-'))) {
        // السيارات الجديدة - عرض رسالة
        ...
        // السيارات من قاعدة البيانات - التوجيه إلى صفحة التفاصيل
