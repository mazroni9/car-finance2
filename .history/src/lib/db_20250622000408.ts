...
export const validateCarData = (data: CarData) => {
  console.warn("⚠️ validateCarData is a dummy function.");
  return true;
};

export const calculateFinancials = (carData: CarData) => {
  console.warn("⚠️ calculateFinancials is a dummy function.");
  return {
    monthlyPayment: 0,
    totalInterest: 0,
  };
