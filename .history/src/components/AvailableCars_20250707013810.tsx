...
export default function AvailableCars() {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-xl font-bold mb-4">🚗 السيارات المتاحة للشراء</h2>
        ...
        <table className="min-w-full bg-white rounded-lg">
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="px-4 py-2 text-right">اللون</th>
              <th className="px-4 py-2 text-right">الممشى</th>
          ...
          <tbody>
            {cars.map((car) => (
              <tr key={car.id} className="border-b hover:bg-gray-50">
                ...
                <td className="px-4 py-2">{car.price.toLocaleString('ar-SA')} ريال</td>
                <td className="px-4 py-2">{car.color}</td>
                <td className="px-4 py-2">{car.mileage.toLocaleString('ar-SA')} كم</td>
