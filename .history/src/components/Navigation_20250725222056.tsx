...
export default function Navigation() {
  ...
  // عرض نسخة بسيطة بدون تفاعل حتى يتم التحميل
  if (!mounted) {
    return (
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-8">
                ...
                <div className="flex gap-4">
                  ...
                  <Link href="/trader-finance" className="nav-link">
                    تمويل التاجر
                  </Link>
                  <Link href="/car-finance" className="nav-link">
                    نظام التأجير التمويلي
                  </Link>
                  <Link href="/car-leasing" className="nav-link">
                    📝 نظام التأجير المطور
                  </Link>
                  <Link href="/reports" className="nav-link">
                    التقارير
                  </Link>
                  <Link href="/dealer/dashboard" className="nav-link">
                    لوحة التاجر
                  </Link>
                  <Link href="/showroom-mazbrothers" className="nav-link">
  ...
  // بعد التحميل، عرض النسخة التفاعلية
  return (
    <header className="w-full bg-[#121212]">
      <nav className="mx-4 my-2">
        <div className="container mx-auto">
