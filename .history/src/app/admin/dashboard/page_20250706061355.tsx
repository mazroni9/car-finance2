...
import PlatformWalletSummary from '@/components/admin/PlatformWalletSummary';
...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      <h1 className="text-3xl font-bold mb-6 text-center text-white">🛠️ لوحة تحكم الإدارة</h1>
