  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start align-top">
        ...
        {/* بطاقة معرض السيارات على اليسار */}
        <div className="order-1 lg:order-2 flex items-start h-full">
          <div className="glass-card p-6 bg-gradient-to-br from-green-100 to-green-50 shadow-md flex flex-col justify-start h-full w-full">
