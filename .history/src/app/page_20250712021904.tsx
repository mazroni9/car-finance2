  ...
  return (
    <div className="space-y-8 mt-10">
      ...
      <div className="w-full bg-blue-900 py-2 overflow-hidden">
        ...
        >
          لماذا تستثمر معنا؟ ✔️ تمويل شرعي | أرباح دورية | تخارج مرن | كل استفساراتك يجيبك عليها فريق الكنترول روم أو صفحة "استثمر معنا" 🚀 لا يردك إلا أرباحك! | طرق تمويل متنوعة | الاشتراك في أنظمتنا شرعي 100% | أرباحك تصلك بانتظام | التخارج متاح بعد سنتين أو خمس سنوات أو حسب رغبتك | استثمر معنا اليوم!
        </div>
      </div>
      {/* Hero Section */}
