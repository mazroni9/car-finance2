    ...
    <div style={{ display: "flex", height: "100vh" }}>
      ...
      <aside style={{
        ...
        <nav className="flex flex-col items-center gap-4 w-full">
          ...
          {/* Components Details */}
          <div className="w-full pt-4 mt-4 border-t border-gray-700">
            <h3 className="text-sm font-medium text-gray-400 mb-2 text-center">Components</h3>
            <Link href="/dashboard/components/manual-registration" className="w-full text-center hover:bg-white/10 py-2 rounded transition-colors block">
              🔍 Manual Registration
            </Link>
          </div>
        </nav>
