...
export default function WalletBalancePage() {
  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-white rounded shadow mt-8">
      <h1 className="text-2xl font-bold mb-4 text-center text-black">🪙 تعديل رصيد المحفظة</h1>

      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block mb-1 font-semibold text-black">📌 معرف المعرض</label>
          <input
            type="text"
            value={showroomId}
        ...
        <div>
          <label className="block mb-1 font-semibold text-black">💰 المبلغ (ريال)</label>
          <input
            type="number"
            value={amount}
            ...
            title="المبلغ بالريال"
          />
        </div>

        <div>
          <label className="block mb-1 font-semibold text-black">🔄 نوع العملية</label>
          <select
            value={operation}
