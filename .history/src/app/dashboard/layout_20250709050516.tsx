    ...
    <div style={{ display: "flex", height: "100vh" }}>
      ...
      <aside style={{
        ...
        <nav className="flex flex-col items-center gap-4 w-full">
          ...
          {/* Arabic Titles */}
          <div className="w-full pt-4 mt-4 border-t border-gray-700 flex flex-col gap-4">
          ...
          <Link href="/dashboard/settlements" className="w-full text-center hover:bg-white/10 py-2 rounded transition-colors">
            💰 مراقبة التسويات
          </Link>
          <Link href="/dashboard/admin_logs/cars/linked-cars" className="w-full text-center hover:bg-white/10 py-2 rounded transition-colors">
            🔄 ربط السيارات
          </Link>
          </div>

          {/* Manual Registration at the bottom */}
