          ...
          <tbody className="divide-y divide-gray-700">
            {wallets.map((wallet) => (
              <tr key={wallet.id} className="hover:bg-gray-700">
                ...
                <td className="px-6 py-4 text-green-400">{wallet.total_ground_fees?.toLocaleString()} ريال</td>
                <td className="px-6 py-4 text-purple-400">{wallet.registration_fees?.toLocaleString()} ريال</td>
