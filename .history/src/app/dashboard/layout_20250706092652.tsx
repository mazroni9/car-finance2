      ...
      <aside style={{
        ...
        <nav className="flex flex-col items-center gap-4 w-full">
          ...
          <div className="w-full pt-4 mt-4 border-t border-gray-700">
            <h3 className="text-sm font-medium text-gray-400 mb-2 text-center">التسجيل اليدوي</h3>
            <Link href="/dashboard/manual-registration" className="w-full text-center hover:bg-white/10 py-2 rounded transition-colors block">
              ✏️ تسجيل معاملة
            </Link>
            <Link href="/dashboard/manual-registration/history" className="w-full text-center hover:bg-white/10 py-2 rounded transition-colors block">
              📜 سجل المعاملات
            </Link>
          </div>
        </nav>
