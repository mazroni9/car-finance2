  ...
  return (
    <div className="mb-8">
      ...
      <div className="text-center text-blue-800 font-semibold">
        إجمالي رأس المال: {totalCapital.toLocaleString()} ريال <br />
        إجمالي عدد العمليات الشهرية: {totalOperations} <br />
        إجمالي المبلغ الممول: {totalFinancedAmount.toLocaleString()} ريال <br />
        إجمالي عدد المشتركين: {totalSubscribers} <br />
      </div>
    </div>
  );
}
