...
export default function SummarySection({ allMonthlyDetails, entries }: SummarySectionProps) {
  ...
  return (
    <div className="mb-16">
      ...
      <h3 className="text-lg font-bold mb-2 text-green-600 flex items-center print:break-before-page" style={{breakBefore: 'page'}}>
      ...
      <h3 className="text-lg font-bold mb-2 text-green-600 print:break-before-page" style={{breakBefore: 'page'}}>
        📈 النتائج السنوية المجمعة
      </h3>
