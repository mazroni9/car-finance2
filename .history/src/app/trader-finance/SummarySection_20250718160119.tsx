      ...
      <div className="overflow-x-auto">
        <table className="table-auto w-full border">
          <tbody>
            ...
            <tr>
              <td className="border p-2 font-bold text-green-800">مجموع عمولة المنصة السنوي</td>
              <td className="border p-2 font-bold text-green-800">{annualTotals.platformCommission?.toLocaleString()} ريال</td>
            </tr>
            <tr>
