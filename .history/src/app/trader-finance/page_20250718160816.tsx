...
export default function Page() {
  ...
  return (
    <main className="max-w-6xl mx-auto p-6">
      <div className="text-center py-4 flex items-center justify-between">
        <h1 className="text-3xl font-bold text-blue-700">
          أهلا بكم في نظام تمويل التجار لدى معارض السيارات
        </h1>
        <button
          onClick={() => window.print()}
          className="ml-4 bg-green-700 hover:bg-green-800 text-white px-4 py-2 rounded shadow text-lg"
        >
          🖨️ طباعة النتائج PDF
        </button>
      </div>
