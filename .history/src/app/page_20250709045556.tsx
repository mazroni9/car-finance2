    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
        ...
        <div className="glass-card p-6 bg-gradient-to-br from-green-100 to-green-50 shadow-md">
          <h3 className="text-xl font-bold mb-3 text-black">💰 مراقبة التسويات المالية</h3>
          <p className="text-black opacity-90 mb-4">
            تتبع وإدارة جميع عمليات التسويات المالية في المنصة
          </p>
          <Link href="/dashboard/settlements" className="text-green-700 hover:text-green-800 font-bold">
            عرض التسويات →
          </Link>
        </div>
      </div>
