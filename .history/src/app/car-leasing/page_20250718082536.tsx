              ...
              <tbody>
                ...
                {getMonthRows().length > 0 && (
                  <tr className="bg-green-200 font-bold">
                    ...
                    <td className="border border-blue-200 px-2 text-black" colSpan={1}></td>
                    <td className="border border-blue-200 px-2 text-blue-900 bg-blue-200 font-extrabold">
                      {Math.round(getMonthRows().reduce((sum, r) => sum + r.extended_lease_months + 12, 0))}
                    </td>
                  </tr>
                )}
                {getMonthRows().length === 0 && (
