    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="w-full flex flex-col items-center mb-6">
          <form className="flex flex-wrap gap-2 justify-center items-end bg-white rounded-lg shadow p-3 w-full max-w-5xl">
            <div className="flex flex-col items-start">
              ...
              <select
                ...
                className="px-2 py-1 border rounded text-sm min-w-[90px]"
                dir="rtl"
              >
            ...
            <button
              type="button"
              onClick={handleSave}
              className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-4 py-2 rounded-lg shadow-md transition-colors text-xs mt-5"
            >
              حفظ المعلومات
            </button>
            <button
              ...
              className="bg-red-600 hover:bg-red-700 text-white font-bold px-4 py-2 rounded-lg shadow-md transition-colors text-xs mt-5"
            >
              حذف جميع البيانات
            </button>
          </form>
