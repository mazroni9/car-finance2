                ...
                {rows.length > 0 && (
                  <tr className="bg-green-200 font-bold">
                    ...
                    <td className="border border-blue-200 px-2 text-purple-900 bg-purple-200 font-extrabold">
                      {rows.reduce((sum, r) => sum + r.extended_lease_total, 0).toLocaleString(undefined, {maximumFractionDigits: 2})}
                    </td>
                    <td className="border border-blue-200 px-2 text-purple-900 bg-purple-200 font-extrabold">
                      {rows.reduce((sum, r) => sum + r.extended_lease_months, 0).toLocaleString(undefined, {maximumFractionDigits: 1})}
                    </td>
                  </tr>
                )}
                {rows.length === 0 && (
                  <tr>
                    <td colSpan={14} className="text-gray-400 py-8">لا توجد بيانات بعد. أدخل البيانات أعلاه واضغط حفظ.</td>
                  </tr>
                )}
              </tbody>
            </table>
