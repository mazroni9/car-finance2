...
export default function CarLeasingPage() {
  ...
  const handleSave = () => {
    setRows((prev: any[]) => {
      const newRows = [...prev, calculateRow(form, selectedMonth)];
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-5xl mx-auto px-4">
        ...
        {/* نموذج الإدخال */}
        <div className="bg-white rounded-lg shadow p-4 mb-8 w-full max-w-md mx-auto flex flex-col gap-4">
          <div className="grid grid-cols-1 gap-4">
            <div className="space-y-1">
              <label htmlFor="priceCategory" className="block text-xs font-medium text-gray-900">الفئة السعرية (ريال)</label>
              <select
                id="priceCategory"
                name="priceCategory"
            ...
            <div className="space-y-1">
              <label htmlFor="durationMonths" className="block text-xs font-medium text-gray-900">مدة الإيجار (شهر)</label>
              <select
                id="durationMonths"
                name="durationMonths"
            ...
            <div className="space-y-1">
              <label htmlFor="quantity" className="block text-xs font-medium text-gray-900">عدد السيارات</label>
              <input
                id="quantity"
                name="quantity"
                type="number"
            ...
            <div className="space-y-1">
              <label htmlFor="lastPaymentPercent" className="block text-xs font-medium text-gray-900">نسبة تمديد الإيجار</label>
              <select
            ...
            <div className="space-y-1">
              <label htmlFor="profitTargetPercent" className="block text-xs font-medium text-gray-900">نسبة الربح المستهدفة</label>
              <input
                ...
                readOnly
                className="block w-full px-3 py-2 border rounded-lg bg-gray-100 text-center font-bold text-sm"
                tabIndex={-1}
              />
            </div>
            <div className="space-y-1">
              <label htmlFor="extraAnnualFee" className="block text-xs font-medium text-gray-900">رسوم سنوية إضافية (ريال)</label>
              <input
                id="extraAnnualFee"
                name="extraAnnualFee"
                type="number"
          ...
          <div className="flex justify-between gap-2 mt-2">
            <button
              ...
              className="bg-red-600 hover:bg-red-700 text-white font-bold px-4 py-2 rounded-lg shadow-md transition-colors text-xs"
            >
              حذف جميع البيانات
            </button>
            <button
              onClick={handleSave}
              className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 py-2 rounded-lg shadow-md transition-colors text-xs"
            >
              حفظ المعلومات
            </button>
          </div>
