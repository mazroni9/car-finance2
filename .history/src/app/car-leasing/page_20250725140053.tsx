  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-5xl mx-auto px-4">
        <h1 className="text-2xl font-bold text-center mb-8 text-black">اضافة بيانات نظام استئجرها المدة المحددة وان التزمت بدون تأخير بعدها فهي لك</h1>
        {/* نموذج الإدخال */}
        ...
        <div className="w-full flex flex-col items-center mb-6">
          <form className="flex flex-wrap gap-2 justify-between items-end bg-white rounded-lg shadow p-3 w-full max-w-5xl">
            ...
            <button
              ...
              className="bg-red-600 hover:bg-red-700 text-white font-bold px-4 py-2 rounded-lg shadow-md transition-colors text-xs mt-5 order-2 mr-auto"
            >
              حذف جميع البيانات
            </button>
              ...
              <tbody>
                {getMonthRows().map((row, idx) => (
                  ...
                  >
                    ...
                    <td className="border border-blue-200 px-2 text-black">{row.profit_target_percent}</td>
                    <td className="border border-blue-200 px-2 text-black font-bold">{row.base_profit.toLocaleString()}</td>
                    <td className="border border-blue-200 px-2 text-black">{row.last_payment_percent}</td>
      ...
      {/* وصف المعادلات في الأسفل */}
      <div className="text-xs text-gray-700 mt-4 text-center">
        <div>معادلة العائد على الاستثمار (ROI): (الإيجار السنوي المعتمد + الرسوم الإدارية + قيمة الفئة) ÷ تكلفة الفئة - 1</div>
        <div>معادلة ROI المحتمل عند استكمال العقد: (الإيجار السنوي المعتمد + الإيجار الممتد + الرسوم الإدارية + قيمة الفئة) ÷ تكلفة الفئة - 1</div>
      </div>
    </div>
  );
} 