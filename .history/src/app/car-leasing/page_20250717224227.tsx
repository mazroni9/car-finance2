              ...
              <tbody>
                {rows.map((row, idx) => (
                  ...
                  >
                    ...
                    <td className="border border-blue-200 px-2 text-purple-900 bg-purple-100 font-bold">{((row.last_payment_value * 0.3) + row.extra_annual_fee).toLocaleString(undefined, {maximumFractionDigits: 2})}</td>
                    <td className="border border-blue-200 px-2 text-black">{row.extra_annual_fee.toLocaleString()}</td>
                    <td className="border border-blue-200 px-2 text-blue-900 bg-blue-100 font-extrabold text-lg">{row.base_profit.toLocaleString()}</td>
