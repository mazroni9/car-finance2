              ...
              <tbody>
                {rows.map((row, idx) => (
                  ...
                  >
                    ...
                    <td className="border border-blue-200 px-2 text-purple-900 bg-purple-100 font-bold">{row.extended_lease.toLocaleString(undefined, {maximumFractionDigits: 2})}</td>
                  </tr>
                ))}
                {rows.length > 0 && (
