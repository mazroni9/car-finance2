            ...
            <table className="min-w-full w-full text-sm text-center border border-blue-200 rounded-lg overflow-hidden">
              <thead>
                <tr className="bg-blue-800 text-white">
                  ...
                  <th className="border border-blue-200 px-2 font-bold">نسبة الرسوم الإدارية</th>
                  ...
                  <th className="border border-blue-200 px-2 font-bold">نسبة التأمين السنوي</th>
                  <th className="border border-blue-200 px-2 font-bold">قيمة التأمين السنوي</th>
              ...
              <tbody>
                {rows.map((row, idx) => (
                  ...
                  >
                    ...
                    <td className="border border-blue-200 px-2 text-black">{(row.down_payment_percent * 100).toFixed(0)}%</td>
                    ...
                    <td className="border border-blue-200 px-2 text-black">{(row.insurance_percent * 100).toFixed(0)}%</td>
