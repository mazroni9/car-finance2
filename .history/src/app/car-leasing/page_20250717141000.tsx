      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* نسبة التأمين السنوي */}
            <div className="space-y-2">
              <label htmlFor="insurancePercent" className="block text-sm font-medium text-gray-900">
                نسبة التأمين السنوي <span className="text-xs text-gray-500">(يمكنك تعديلها حسب قيمة السيارة)</span>
              </label>
              <input
                id="insurancePercent"
                ...
                onChange={handleChange}
                className="block w-full px-4 py-3 border rounded-lg"
                placeholder="مثلاً: 0.1 للنسبة 10%"
                title="أدخل نسبة التأمين السنوي (مثلاً: 0.1 للنسبة 10%)"
              />
            </div>
            <div className="space-y-2">
