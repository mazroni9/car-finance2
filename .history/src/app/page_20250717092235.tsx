    ...
    <div className="space-y-8 mt-10">
      ...
      <div className="glass-card p-8 bg-gradient-to-br from-blue-100 to-blue-50 shadow-md text-center relative">
        ...
        <div className="flex justify-center flex-wrap gap-4">
          ...
          <Link href="/admin/car-finance-entry" className="bg-purple-600 hover:bg-purple-700 text-white font-bold text-lg px-8 py-3 rounded-lg shadow-md flex items-center gap-2">
            <span>📝</span>
            <span>إدارة قواعد التمويل</span>
          </Link>
        ...
        <div className="flex justify-center flex-wrap gap-4">
          ...
          >
            ...
            <div className="text-right">
              <div className="font-bold">إدارة قواعد التمويل</div>
              <div className="text-sm opacity-90">Car Finance Rules Management</div>
            </div>
          </Link>
          <Link 
            href="/car-finance" 
      ...
      <div className="mt-8 flex justify-center gap-4">
        ...
        <a
          href="/admin/car-finance-entry"
          className="bg-purple-600 hover:bg-purple-700 text-white font-bold text-lg px-8 py-3 rounded-lg shadow-md transition-colors flex items-center gap-2"
        >
          <span>📝</span>
          <span>إدارة قواعد التمويل</span>
        </a>
