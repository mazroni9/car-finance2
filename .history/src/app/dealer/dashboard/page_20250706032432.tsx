...
export default function DealerDashboard() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      <h1 className="text-3xl font-bold mb-6 text-center">🚀 لوحة تحكم التاجر</h1>
      ...
      {/* ✅ المعرض لشراء السيارات */}
      <div className="bg-white p-6 rounded-lg shadow-lg">
        <h2 className="text-xl font-bold mb-4">🚗 معرض السيارات</h2>
        <CarShowcase />
      </div>
