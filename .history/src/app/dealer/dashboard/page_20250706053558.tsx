...
export default function DealerDashboard() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      <h1 className="text-3xl font-bold mb-6 text-center text-gray-900">لوحة تحكم التاجر 🚀</h1>

      {/* ملخص المحفظة */}
      <div className="bg-white rounded-lg shadow-lg p-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold mb-4 text-gray-900">ملخص المحفظة 💰</h2>
          <span className="text-2xl">💰</span>
        </div>
        <WalletSummary />
      </div>

      {/* عرض معلومات المحفظة الحالية */}
      <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
        <h3 className="text-xl font-semibold mb-4 text-gray-900">💰 رصيدك</h3>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold mb-4 text-gray-900">معرض السيارات 🚗</h2>
          <span className="text-2xl">🚗</span>
        </div>
        <CarShowcase />
      </div>
      ...
      {/* عمليات الشراء */}
      <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
        <h3 className="text-xl font-semibold mb-4 text-gray-900">🛒 عملية شراء</h3>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold mb-4 text-gray-900">سجل المبيعات 📋</h2>
          <span className="text-2xl">📋</span>
        </div>
        <DealerSalesHistory />
      </div>
