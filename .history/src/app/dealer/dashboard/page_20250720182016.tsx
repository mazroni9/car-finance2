          ...
          <table className="min-w-full border-collapse">
            <thead>
              <tr className="bg-black">
                <th className="text-white px-4 py-2 border-b">التاريخ والوقت</th>
                <th className="text-white px-4 py-2 border-b">نوع العملية</th>
                <th className="text-white px-4 py-2 border-b">المبلغ</th>
                <th className="text-white px-4 py-2 border-b">الرصيد بعد العملية</th>
                <th className="text-white px-4 py-2 border-b">الوصف</th>
              </tr>
            </thead>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full relative animate-fadeIn">
            ...
            <div className="mt-6 flex gap-2 justify-end">
              <button 
                onClick={() => window.open("/DASM-e-بتش-ديك.pdf", "_blank")}
