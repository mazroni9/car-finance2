        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="col-span-2">
              <h3 className="text-2xl font-bold mb-4">Maz Brothers Car Showroom</h3>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                <li><a href="/car-finance" className="hover:text-white">Traditional Financing</a></li>
                <li><a href="/car-leasing" className="hover:text-white">Advanced Leasing</a></li>
                <li><a href="/trader-finance" className="hover:text-white">Trader Finance</a></li>
                <li><a href="/cars" className="hover:text-white">Car Showroom</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2025 Maz Brothers Car Showroom. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
