    ...
    <div className="space-y-8 mt-10">
      ...
      <div className="glass-card p-8 bg-gradient-to-br from-purple-100 to-purple-50 shadow-md text-center">
        ...
        <div className="flex justify-center flex-wrap gap-4">
          <Link 
            href="/trader-finance" 
            className="bg-green-700 hover:bg-green-800 text-white font-bold text-xl px-8 py-4 rounded-lg shadow-lg transition-all duration-300 transform hover:scale-105 flex items-center gap-3"
          >
