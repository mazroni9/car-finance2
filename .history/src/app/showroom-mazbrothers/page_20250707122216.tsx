...
export default function ShowroomPage() {
  ...
  return (
    <div>
      ...
      {/* العنوان في سطر مستقل وفي المنتصف */}
      <div className="flex justify-center mb-10">
        <h1 className="text-3xl font-bold text-white text-center">🏬 لوحة تحكم معرض mazbrothers</h1>
      </div>

      {/* أزرار ربط السيارات وتسجيل طلب جديد في سطر مستقل */}
