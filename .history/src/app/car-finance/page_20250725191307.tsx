...
export default function CarFinancePage() {
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-2xl font-bold text-center mb-8 text-black">جدول قواعد التمويل الاحترافي</h1>
      {/* نموذج الإدخال */}
      <form onSubmit={handleFormSubmit} className="bg-white rounded-lg shadow-md p-6 mb-8 flex flex-col md:flex-row items-end gap-4">
        <div className="flex flex-col">
          <label className="font-bold mb-1">فئة السعر</label>
          <input type="number" name="price_category" value={form.price_category} onChange={handleFormChange} className="border rounded px-2 py-1" min={0} required />
        </div>
        <div className="flex flex-col">
          <label className="font-bold mb-1">مدة العقد (شهر)</label>
          <select name="duration_months" value={form.duration_months} onChange={handleFormChange} className="border rounded px-2 py-1">
        ...
        <div className="flex flex-col">
          ...
          <input type="number" name="car_count" value={form.car_count} onChange={handleFormChange} className="border rounded px-2 py-1" min={1} required />
        </div>
        <div className="flex flex-col">
          <label className="font-bold mb-1">نسبة الربح (%)</label>
          <input type="number" name="profit_percent" value={form.profit_percent} onChange={handleFormChange} className="border rounded px-2 py-1" min={0} max={100} required />
        </div>
        <div className="flex flex-col">
          <label className="font-bold mb-1">نسبة الدفعة الأخيرة</label>
          <select name="last_payment_percent" value={form.last_payment_percent} onChange={handleFormChange} className="border rounded px-2 py-1">
        ...
        <div className="flex flex-col">
          <label className="font-bold mb-1">مبلغ الدفعة الأخيرة</label>
          <input type="number" name="last_payment" value={form.last_payment} readOnly className="border rounded px-2 py-1 bg-gray-100" />
        </div>
