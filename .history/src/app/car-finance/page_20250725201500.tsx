...
import '@/public/fonts/Amiri-Regular-normal.js'; // المسار الصحيح للملف

function handleExportSummaryToPDF() {
  const doc = new jsPDF({
    orientation: 'p',
    unit: 'pt',
    format: 'a4'
  ...
  doc.text('ملخصك المالي', 400, 60, { align: 'right' });

  // ... أضف بقية النصوص بنفس الطريقة مع align: 'right'
