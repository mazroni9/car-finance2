    ...
    <div className="container mx-auto py-8">
      ...
      <form onSubmit={handleFormSubmit} className="bg-white rounded-lg shadow-md p-6 mb-8 flex flex-col md:flex-row items-end gap-4">
        <div className="flex flex-col">
          ...
          <input type="number" name="price_category" value={form.price_category} onChange={handleFormChange} className="border rounded px-2 py-1" min={0} required title="فئة السعر" placeholder="أدخل فئة السعر" />
        </div>
        <div className="flex flex-col">
        ...
        <div className="flex flex-col">
          ...
          <input type="number" name="last_payment" value={form.last_payment} readOnly className="border rounded px-2 py-1 bg-gray-100" title="مبلغ الدفعة الأخيرة" placeholder="سيتم حسابه تلقائياً" />
        </div>
      ...
      {/* فاصل جمالي */}
      <div className="my-8 border-t-2 border-blue-200" />
      {/* عنوان جدول قواعد التمويل الاحترافي داخل بطاقة */}
      <div className="bg-blue-800 rounded-lg shadow-md p-4 mb-6 text-center">
        <h2 className="text-xl font-bold text-white tracking-wider">جدول قواعد التمويل الاحترافي</h2>
      </div>
