...
export default function CarFinancePage() {
  ...
  // جدول ثابت للفئات السعرية ولكل فئة جميع مدد التمويل
  const staticFinanceRules = priceCategories.flatMap((cat) => [12, 18, 24, 30, 36].map((duration) => ({
    price_category: cat,
    duration_months: duration,
    profit_target_percent: profitPercentByDuration[duration] || 0.3,
    base_profit: 0,
          ...
          <div className="bg-white rounded-lg shadow p-4 mb-4 flex flex-wrap items-center gap-2 justify-between">
            <div className="flex flex-wrap items-center gap-2 w-full justify-end">
              ...
              <div className="flex flex-col items-center">
                ...
                <input name="profit_target_percent" type="text" value={`${Math.round(Number(form.profit_target_percent) * 100)}%`} readOnly className="border rounded px-2 py-1 w-16 text-center bg-gray-100 font-bold" />
              </div>
              <div className="flex flex-col items-center">
            ...
            <div className="overflow-x-auto w-full">
              <table className="w-full divide-y divide-gray-200 text-gray-900">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {staticFinanceRules.map((rule, index) => (
