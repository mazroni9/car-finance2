      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-red-50 dark:bg-red-900/20 rounded-lg p-6 flex flex-col items-center justify-center transition-all hover:shadow-lg">
          <button
            ...
            className="flex items-center gap-2 bg-cyan-200 hover:bg-cyan-300 text-blue-900 font-bold px-6 py-3 rounded-lg shadow-md transition-colors text-base border border-cyan-400"
          >
