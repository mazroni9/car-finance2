...
export default function ManualDataEntry({ onAddData }: ManualDataEntryProps) {
  ...
  const handleInputChange = (field: keyof FinanceData, value: number) => {
    ...
    if (field === 'price_category' || field === 'profit_percent' || field === 'first_payment' || field === 'last_payment' || field === 'duration_months') {
      ...
      newFormData.annual_income = Math.round(monthlyIncome * 12);
    }
    ...
    if (field === 'car_count') {
      ...
      // حساب الدخل السنوي = الدخل الشهري × 12
      newFormData.annual_income = Math.round(newFormData.monthly_income * 12);
    }
