...
export default function ProfessionalFinanceTable({ data, onDataChange }: ProfessionalFinanceTableProps) {
  ...
  const handleSave = () => {
    if (editData) {
      ...
      // حساب القسط الشهري = (الفئة السعرية + الربح - الدفعة الأولى - الدفعة الأخيرة) ÷ مدة التمويل
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        <h4 className="text-lg font-semibold text-blue-800 mb-2">📊 معادلات الحساب:</h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-blue-700">
          <div>
            <strong>الربح =</strong> الفئة السعرية × نسبة الربح
          </div>
          <div>
            <strong>سعر البيع بالتقسيط =</strong> الفئة السعرية + الربح
          </div>
          <div>
            <strong>القسط الشهري =</strong> (سعر البيع بالتقسيط - الدفعة الأولى - الدفعة الأخيرة) ÷ مدة التمويل
          </div>
          <div>
            <strong>الدخل الشهري =</strong> القسط الشهري × عدد السيارات
          </div>
          <div>
            <strong>كم نقدر نشتري =</strong> الفئة السعرية × عدد السيارات
          </div>
          <div>
            <strong>الدخل السنوي =</strong> الدخل الشهري × 12
          </div>
        </div>
      </div>
