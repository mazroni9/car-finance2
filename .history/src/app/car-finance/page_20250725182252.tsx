      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="space-y-8">
          ...
          <div className="flex justify-center mt-6">
            <div className="bg-white rounded-lg shadow-lg p-6 flex items-center gap-4">
              <button
                ...
                className="bg-red-600 hover:bg-red-700 text-white font-bold px-6 py-3 rounded-lg shadow-md transition-colors text-base"
              >
          ...
          <div className="glass-card p-4 mb-6 flex flex-col md:flex-row md:items-end md:justify-between gap-4 bg-gradient-to-br from-blue-50 to-blue-100 shadow-md">
            ...
            <div className="flex flex-row md:flex-col items-end md:items-start justify-end md:justify-end w-full md:w-auto">
              <button
