            ...
            {!showCosts ? (
              ...
              <div className="bg-gray-50 p-4 rounded-lg border mt-4">
                ...
                <ul className="mb-4 space-y-2">
                  <li>سعر السيارة: <span className="font-bold">{car.price.toLocaleString('ar-SA')} ريال</span></li>
                  <li>عمولة المنصة: <span className="font-bold">{platformFee.toLocaleString('ar-SA')} ريال</span></li>
                  <li>عمولة المعرض: <span className="font-bold">{showroomFee.toLocaleString('ar-SA')} ريال</span></li>
                  <li>الإجمالي: <span className="font-bold text-blue-600">{total.toLocaleString('ar-SA')} ريال</span></li>
                </ul>
