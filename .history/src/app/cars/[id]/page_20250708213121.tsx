            ...
            {!showCosts ? (
              ...
              <div className="bg-blue-900 p-4 rounded-lg border mt-4">
                ...
                <ul className="mb-4 space-y-2">
                  ...
                  <li>عمولة المنصة: <span className="font-bold text-white">{typeof platformFee === 'number' ? platformFee.toLocaleString('ar-SA') + ' ريال' : 'غير متوفر'}</span></li>
                ...
                {success ? (
                  <div className="text-green-300 font-bold mb-2">تم تنفيذ العملية بنجاح!</div>
                ) : (
                  <button
