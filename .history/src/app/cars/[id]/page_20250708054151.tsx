      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-1/2 space-y-6">
          ...
          <table className="w-full text-right border rounded-lg bg-white">
            <tbody>
              <tr><td className="font-bold">السعر</td><td>{car.price.toLocaleString('ar-SA')} ريال</td></tr>
              <tr><td className="font-bold">اللون</td><td>{car.color}</td></tr>
              <tr><td className="font-bold">المسافة المقطوعة</td><td>{car.mileage.toLocaleString('ar-SA')} كم</td></tr>
