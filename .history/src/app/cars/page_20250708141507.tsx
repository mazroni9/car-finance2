      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-black font-medium">
            تصفح مجموعتنا المختارة من السيارات المستعملة للبيع نقداً وعبر نظام التأجير المنتهي بالتمليك والبيع بالتقسيط وأنظمة تمويلية مخصصة للتجار
          </p>
        </div>
            ...
            >
              ...
              <div className="p-4 text-right space-y-2 flex-1 flex flex-col justify-between">
                ...
                <button
                  ...
                  className="w-full mt-2 py-2 px-4 rounded-lg bg-green-600 text-white font-bold hover:bg-green-700 transition-all text-sm"
                  title="شراء هذه السيارة"
                >
                  ✅ شراء
                </button>
              </div>
