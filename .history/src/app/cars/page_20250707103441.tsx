      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {cars.map((car) => (
            <div
              key={car.id}
              className="flex flex-col rounded-2xl overflow-hidden border shadow-md hover:shadow-xl bg-white transition-all duration-300"
            >
              <Link
                href={`/cars/${car.id}`}
              ...
              <div className="p-5 text-right space-y-3 flex-1 flex flex-col justify-between">
                ...
                <button
                  disabled
                  className="w-full mt-4 py-2 px-4 rounded-lg bg-green-600 text-white font-bold hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
