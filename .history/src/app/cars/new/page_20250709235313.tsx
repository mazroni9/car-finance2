...
export default function NewCarPage() {
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4 flex justify-center items-start">
      <div className="flex justify-end mb-6 w-full max-w-2xl">
        <Link
          href="/"
      ...
      <div className="bg-white/80 rounded-2xl shadow-2xl p-8 max-w-2xl w-full mx-auto border border-gray-200 backdrop-blur-md">
        <CarEntryForm />
      </div>
    </div>
  );
