...
export async function POST(request) {
  try {
    ...
    const insertData = {
      price_category,
      duration_months,
      profit_target_percent: calculatedProfitTargetPercent,
      down_payment_value: calculatedDownPaymentValue,
      last_payment_value: calculatedLastPaymentValue,
      quantity,
      monthly_installment: calculatedMonthlyInstallment,
      possible_purchase_amount: calculatedPossiblePurchaseAmount,
      tracking_cost,
      guarantee_contract_cost,
      inspection_cost,
      profit_per_car: calculatedProfitPerCar
    };
