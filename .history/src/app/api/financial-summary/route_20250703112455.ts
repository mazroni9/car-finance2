...
export async function GET() {
  ...
  try {
    ...
    const formattedSummary = {
      total_monthly_installments: summary.total_monthly_installments || 0,
      total_annual_income: summary.total_annual_income || 0,
      total_purchase_cost: summary.total_purchase_cost || 0,
      total_profit_full_period: summary.total_profit_full_period || 0,
      avg_roi_full_period: summary.avg_roi_full_period || 0,
      avg_roi_annual: summary.avg_roi_annual || 0,
      total_down_payments: summary.total_down_payments || 0,
      total_last_payments_per_year: summary.total_last_payments_per_year || 0,
      total_annual_profit_before_costs: summary.total_annual_profit_before_costs || 0
    };
