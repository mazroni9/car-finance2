  ...
  return (
    <div className="space-y-8 mt-10">
      ...
      <div className="w-full overflow-hidden bg-blue-900 text-white font-bold text-lg py-2">
        ...
        >
          لماذا تستثمر معنا؟            ✔️                       
          <span style={{ display: "inline-block", width: 300 }}></span>
          بكل بساطة لأننا نقدم لك فرصة استثمارية متوافقة مع الشريعة عبر صكوك تمويلية وصناديق جماعية مخصصة لتمويل عمليات البيع بالتقسيط. استثمر معنا لتكون شريكًا في دعم تجارة السيارات والتمويل المباشرللتجار والافراد  على حد سواء مع تحقيق عوائد مستقرة من أرباح التمويل والمبيعات.
          ...
          <span style={{ display: "inline-block", width: 80 }}></span>
          <span style={{ display: "inline-block", width: 180 }}></span>
          اقدم واستثمر في DASM-e والله لو قالت الهيلا استثمر اني لاستثمر
        </div>
      </div>
      {/* Hero Section */}
