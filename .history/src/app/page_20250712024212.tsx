...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const handleAnimationIteration = () => {
      setIsPaused(true);
      setTimeout(() => setIsPaused(false), 5000); // توقف 5 ثواني
    };
  ...
  return (
    <div className="space-y-8 mt-10">
      ...
      <div className="w-full bg-blue-900 py-2 overflow-hidden">
        ...
        >
          لماذا تستثمر معنا؟ ✔️ تمويل شرعي          |          طرق تمويل متنوعة          |          أرباح دورية تصلك بانتظام          |          التخارج متاح بعد سنتين أو خمس سنوات أو حسب رغبتك          |          كل استفساراتك يجيبك عليها فريق الكنترول روم أو صفحة "استثمر معنا"          |          الاشتراك في أنظمتنا شرعي 100%          |          استثمر معنا اليوم 🚀 لا يردك إلا أرباحك!          |          اقدم واستثمر والله لو قالت السعوديه اقدم اني لاقدم          |          لماذا تستثمر معنا؟ ✔️ تمويل شرعي          |          طرق تمويل متنوعة          |          أرباح دورية تصلك بانتظام          |          التخارج متاح بعد سنتين أو خمس سنوات أو حسب رغبتك          |          كل استفساراتك يجيبك عليها فريق الكنترول روم أو صفحة "استثمر معنا"          |          الاشتراك في أنظمتنا شرعي 100%          |          استثمر معنا اليوم 🚀 لا يردك إلا أرباحك!          |          اقدم واستثمر والله لو قالت السعوديه اقدم اني لاقدم
        </div>
      </div>
      {/* Hero Section */}
