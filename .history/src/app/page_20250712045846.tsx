    ...
    <div className="space-y-8 mt-10">
      ...
      <div className="w-full overflow-hidden bg-blue-900 text-white font-bold text-lg py-2">
        ...
        >
          ...
          بكل بساطة لأننا نقدم لك فرصة استثمارية متوافقة مع الشريعة عبر صكوك تمويلية وصناديق جماعية مخصصة لتمويل عمليات البيع بالتقسيط. استثمر معنا لتكون شريكًا في دعم تجارة السيارات والتمويل المباشرللتجار والافراج على حد سواء مع تحقيق عوائد مستقرة من أرباح التمويل والمبيعات.
