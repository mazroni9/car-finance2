        ...
        <Card className="p-6 w-full max-w-md mx-auto">
          ...
          <div className="space-y-4">
            <div className="text-center">
              ...
              <input
                type="number"
                className="input-field w-full text-center text-black font-medium bg-white"
                value={priceCategory || ''}
            ...
            <div className="text-center">
              <label className="block text-sm font-bold mb-2 text-black" id="down-payment-rate">نسبة الدفعة الأولى</label>
              <select
                className="select-field w-full text-center text-black font-medium bg-white"
            ...
            <div className="text-center">
              <label className="block text-sm font-bold mb-2 text-black" id="last-payment-rate">نسبة الدفعة الأخيرة</label>
              <select
                className="select-field w-full text-center text-black font-medium bg-white"
            ...
            <div className="text-center">
              <label className="block text-sm font-bold mb-2 text-black" id="installment-months">مدة التقسيط</label>
              <select
                className="select-field w-full text-center text-black font-medium bg-white"
                value={months}
