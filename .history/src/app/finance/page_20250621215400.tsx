  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="p-6 w-full max-w-md mx-auto bg-gradient-to-br from-blue-50 to-white shadow-md md:col-start-2">
        ...
        <Card className="p-6 w-full max-w-md mx-auto bg-gradient-to-br from-blue-50 to-white shadow-md md:col-start-1 md:row-start-1">
