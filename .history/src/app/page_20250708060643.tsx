...
export default function HomePage(): ReactNode {
  return (
    <div className="space-y-8">
      ...
      {/* Grid Layout: نموذج + Features */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start align-top">
        {/* النموذج على اليمين */}
        <div className="order-2 lg:order-1 lg:pr-8 flex items-start h-full">
          <CarEntryForm className="text-black w-full" />
        </div>
        {/* Features Grid على اليسار */}
        <div className="order-1 lg:order-2 flex items-start h-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
            <div className="glass-card p-6 bg-gradient-to-br from-green-100 to-green-50 shadow-md flex flex-col justify-start h-full">
              ...
              <Link href="/cars" className="text-green-700 hover:text-green-800 font-bold mt-auto">
                استعرض المعرض →
              </Link>
            </div>
