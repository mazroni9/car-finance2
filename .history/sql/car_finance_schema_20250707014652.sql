...
INSERT INTO cars (model, brand, year, price, color, mileage, status)
VALUES 
  ('Camry', 'Toyota', 2021, 75000, 'أبيض', 15000, 'available'),
  ('Sonata', 'Hyundai', 2022, 82000, 'أسود', 10000, 'available'),
  ('Accord', 'Honda', 2023, 95000, 'فضي', 5000, 'available'),
  ('Elantra', 'Hyundai', 2022, 68000, 'أحمر', 20000, 'available');
