...
-- =====================================================
-- 0. حذف الجداول والدوال الموجودة مسبقاً
-- =====================================================

-- حذف الجداول بالترتيب العكسي (تجنباً لمشاكل المراجع)
...
DROP FUNCTION IF EXISTS update_dealer_wallet_balance() CASCADE;
DROP FUNCTION IF EXISTS link_cars_to_showroom(uuid) CASCADE;
DROP FUNCTION IF EXISTS get_financial_summary() CASCADE;
DROP FUNCTION IF EXISTS update_car_showcase_updated_at() CASCADE;
...
DROP TRIGGER IF EXISTS update_wallet_balance_on_transaction ON wallet_transactions;
...
DROP TRIGGER IF EXISTS update_dealer_wallet_balance_on_transaction ON dealer_transactions;
...
VALUES 
  ...
  ('هيونداي', 'سوناتا', 2022, 82000, 'https://res.cloudinary.com/demo/image/upload/sonata-2022.jpg',
   ARRAY['https://res.cloudinary.com/demo/image/upload/sonata-2022-1.jpg', 'https://res.cloudinary.com/demo/image/upload/sonata-2022-2.jpg'],
   'أسود', 10000, 'بنزين', 'هيونداي سوناتا 2022 اقتصادية'),
  ('هوندا', 'أكورد', 2023, 95000, 'https://res.cloudinary.com/demo/image/upload/accord-2023.jpg',
   ARRAY['https://res.cloudinary.com/demo/image/upload/accord-2023-1.jpg', 'https://res.cloudinary.com/demo/image/upload/accord-2023-2.jpg'],
